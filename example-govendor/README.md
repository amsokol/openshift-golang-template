...
```
s2i build https://github.com/amsokol/openshift-golang-template.git amsokol/golang-openshift:1.8.4-1 golang1 -e GOPROJECT_ROOT=github.com/amsokol/openshift-golang-template/example-govendor -e GOPROJECT_CMD=cmd/server --context-dir /example-govendor
```
