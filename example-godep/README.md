...
12. Set `Context Dir` to `/example-godep`

13. Add the following environment variables to `Build Configuration` section:
- GOPROJECT_ROOT=github.com/amsokol/openshift-golang-template/example-godep
...
In example above "main()" function of "main" package is located in `github.com/amsokol/openshift-golang-template/example-godep/cmd/server`.
GOPROJECT_ROOT is set to `github.com/amsokol/openshift-golang-template/example-godep`.
...
```
s2i build https://github.com/amsokol/openshift-golang-template.git amsokol/golang-openshift:1.8.3-2 golang1 -e GOPROJECT_ROOT=github.com/amsokol/openshift-golang-template/example-godep -e GOPROJECT_CMD=cmd/server --context-dir /example-godep
```
