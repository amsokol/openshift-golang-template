...
12. Set `Context Dir` to `/example-glide`

13. Add the following environment variables to `Build Configuration` section:
- GOPROJECT_ROOT=github.com/amsokol/openshift-golang-template/example-glide
...
```
s2i build https://github.com/amsokol/openshift-golang-template.git amsokol/golang-openshift:1.8.5-1 golang1 -e GOPROJECT_ROOT=github.com/amsokol/openshift-golang-template/example-glide -e GOPROJECT_CMD=cmd/server --context-dir /example-glide
```
